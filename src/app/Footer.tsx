...
export default function Footer() {
  return (
    <footer className="footer flex justify-around bg-base-300 p-16 text-lg text-base-content">
      ...
      <nav>
        <header className="footer-title  text-orange-400 opacity-100">Company</header>
      ...
      <nav>
        <header className="footer-title ml-10 text-center  text-orange-400 opacity-100 ">Social</header>
